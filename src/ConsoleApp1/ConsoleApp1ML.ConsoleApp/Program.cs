...
namespace ConsoleApp1ML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\allenlooplee\Desktop\HeartTraining.Preprocessed.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Num} | Predicted value: {predictionResult.Prediction}");
